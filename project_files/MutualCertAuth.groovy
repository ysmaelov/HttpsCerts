...
class Main {
    ...
    private static SSLContext buildSslContext() {
        return SslConfigurator.newInstance()
                .trustStoreFile("C:\\Users\\Ysmaelov\\Workspace\\docker\\nginx_certificates\\ca.jks")
                //.trustStoreFile("ca-unknown.jks")
                .trustStorePassword("ismael")
                .keyStoreFile("C:\\Users\\Ysmaelov\\Workspace\\docker\\nginx_certificates\\client.jks")
